...
//		[2_1_c] When the ball falls down and touches the top of the paddle (opposite direction: ball right, paddle left) 
		...
		PaddleState myNewPaddle2_1_c = new PaddleState(new Point(24990,23000),new Point (27990,24000), paddleDir_1*PADDLE_VELOCITY);
				
		// new BreakoutState2_1_c
		BreakoutState myBreakoutState2_1_c = new BreakoutState(myBalls2_1_c,myBlocks,myBottomRight, myPaddle_1);
		...
		assertEquals(myBreakoutState2_1_c.getPaddle().getTl(),new Point(24990,23000)); 
		assertEquals(myBreakoutState2_1_c.getPaddle().getBr(),new Point(27990,24000)); 
...
//      [2_2_b] When the ball falls down and touches the left of the paddle (ball right, paddle left) (no squeezed) 
		// new Ball2_2_b
		...
		BallState myNewBall2_2_b = new BallState(new Point(24280,23100),new Point(24980,23800), new Vector(-7,7));		 		                              
		...
		PaddleState myNewPaddle2_2_b = new PaddleState(new Point(24990,23000),new Point (27990,24000), paddleDir_1*PADDLE_VELOCITY);
		
		// new BreakoutState2_2_b
		BreakoutState myBreakoutState2_2_b = new BreakoutState(myBalls2_2_b,myBlocks,myBottomRight,myPaddle_1);
		...
		assertEquals(myBreakoutState2_2_b.getBalls()[0].getTl(),new Point(24280,23100));
		assertEquals(myBreakoutState2_2_b.getBalls()[0].getBr(),new Point(24980,23800));
		...
		assertEquals(myBreakoutState2_2_b.getPaddle().getTl(),new Point(24990,23000));
		assertEquals(myBreakoutState2_2_b.getPaddle().getBr(),new Point(27990,24000));
		assertEquals(myBreakoutState2_2_b.getPaddle().getVelocity(),-10); 

		
//     [2_2_c] When the ball falls down and touches the left of the paddle (ball left, paddle left) (squeezed) 
		// new Ball2_3_c
		...
		BallState myNewNewBall2_2_c = new BallState(new Point(0,23107),new Point(700,23807), new Vector(0,7));


		BallState[] myBalls2_2_c = new BallState[] {myBall2_2_c};	
		BallState[] myNewBalls2_2_c = new BallState[] {myNewBall2_2_c};
		BallState[] myNewNewBalls2_2_c = new BallState[] {myNewNewBall2_2_c};
		...
		PaddleState myNewPaddle2_2_c = new PaddleState(new Point(710,23000),new Point(3710,24000), paddleDir0*PADDLE_VELOCITY);
		PaddleState myNewNewPaddle2_2_c = new PaddleState(new Point(700,23000),new Point(3700,24000), paddleDir0*PADDLE_VELOCITY);
		...
		assertEquals(myBreakoutState2_2_c.getPaddle().getTl(),new Point(710,23000));
		assertEquals(myBreakoutState2_2_c.getPaddle().getBr(),new Point(3710,24000));
...
//      [2_3_b] When the ball falls down and touches the right of the paddle (ball left, paddle right) (no squeezed) 
		// new Ball2_3_b
		Point myBallTl2_3_b = new Point(25000+5,23100-7);
		Point myBallBr2_3_b = new Point(25700+5,23800-7);
		...
		BallState myNewBall2_3_b = new BallState(new Point(23620,23100),new Point(24320,23800), new Vector(7,7));
			 		                               //(25000,23100)
		BallState[] myBalls2_3_b = new BallState[] {myBall2_3_b};	
		BallState[] myNewBalls2_3_b = new BallState[] {myNewBall2_3_b};		
		
		// new paddle2_3_b
		Point myNewPaddleTl2_3_b = new Point(25000+10,23000);
		Point myNewPaddleBr2_3_b = new Point(28000+10,24000);
		PaddleState myNewPaddle2_3_b = new PaddleState(new Point(25010,23000),new Point (28010,24000), paddleDir1*PADDLE_VELOCITY);
				
		// new BreakoutState2_2_b
		BreakoutState myBreakoutState2_3_b = new BreakoutState(myBalls2_3_b,myBlocks,myBottomRight,myPaddle1);
		...
		assertEquals(myBreakoutState2_3_b.getBalls()[0].getTl(),new Point(23620,23100));
		assertEquals(myBreakoutState2_3_b.getBalls()[0].getBr(),new Point(24320,23800));
		assertEquals(myBreakoutState2_3_b.getBalls()[0].getVelocity(),new Vector(7,7)); 
		...
		assertEquals(myBreakoutState2_3_b.getPaddle().getTl(),new Point(25010,23000));
		assertEquals(myBreakoutState2_3_b.getPaddle().getBr(),new Point(28010,24000));
		assertEquals(myBreakoutState2_3_b.getPaddle().getVelocity(),10); 

		
//     [2_3_c] When the ball falls down and touches the right of the paddle (ball right, paddle right) (squeezed)
		// new Ball2_3_c
		...
		PaddleState myNewPaddle2_3_c = new PaddleState(new Point(46290,23000),new Point (49290,24000), paddleDir0*PADDLE_VELOCITY);
		...
		assertEquals(myBreakoutState2_3_c.getPaddle().getTl(),new Point(46290,23000));
		assertEquals(myBreakoutState2_3_c.getPaddle().getBr(),new Point(49290,24000));
...
//	 	[3_3] After ball touch three block at same time //error
	    // new Ball3_3
...
//		assertEquals(myBreakoutState3_3.getBalls()[0].getVelocity(),new Vector(5,7)); //error
...
//	    [4] move paddle right to WallRight
		...
		PaddleState myNewPaddle4 = new PaddleState(new Point(47000,23000),new Point (50000,24000), paddleDir0*PADDLE_VELOCITY);
...
//		assertEquals(myBreakoutState4.getPaddle().getVelocity(),myNewBreakoutState4.getPaddle().getVelocity()); 
		...
		assertEquals(myBreakoutState4.getPaddle().getVelocity(),10); 
...
//		[5] move paddle left to WallLeft
		...
		PaddleState myNewPaddle5 = new PaddleState(new Point(0,23000),new Point (3000,24000), paddleDir0*PADDLE_VELOCITY);
...
//		assertEquals(myBreakoutState5.getPaddle().getVelocity(),myNewBreakoutState5.getPaddle().getVelocity()); 
		...
		assertEquals(myBreakoutState5.getPaddle().getVelocity(),-10);
	}
}
